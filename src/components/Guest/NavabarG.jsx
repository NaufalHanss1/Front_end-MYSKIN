...
const Navbar = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/guest/DasboardG") {
      setActiveItem("Beranda");
  
    } else if (location.pathname === "/guest/FaqG") {
      setActiveItem("FAQ1");
    }
  });
        ...
        {openMenu && (
          ...
          >
            <motion.div className="flex flex-col items-center space-y-6 py-4">
              ...
              <button className="text-gray-500 font-medium">Masuk</button>
            </motion.div>
          </motion.div>
        )}
        </AnimatePresence>
